      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button 
            ...
            size="sm"
            onClick={() => {
              // Implémentation réelle de l'export de rapport d'impact législatif
              console.log('Export du rapport d\'impact législatif');
              
              // Créer un rapport détaillé avec toutes les données
              const reportData = {
                title: 'Rapport d\'Impact Législatif',
                date: new Date().toLocaleDateString('fr-FR'),
                summary: 'Analyse complète des impacts des nouvelles législations',
                ...
                compliance: {
                  ...
                  actionRequired: 3,
                  criticalDeadlines: [
                    { title: "Protection des Données", date: "15 juin 2025" },
                    { title: "Code du Travail", date: "1er mars 2025" },
                    { title: "Réglementation Environnementale", date: "30 avril 2025" }
                  ]
                },
                recommendations: [
                  'Renforcer la formation des agents publics',
                  'Améliorer la communication sur les nouvelles dispositions',
                  'Mettre en place un suivi des impacts économiques',
                  'Développer des outils d\'évaluation continue'
                ]
              };
              
              // Générer le rapport en format JSON avec métadonnées
              const reportContent = {
                metadata: {
                  generatedAt: new Date().toISOString(),
                  version: '2.1.0',
                  author: 'Système dalil.dz',
              ...
              notification.innerHTML = `
                <div class="flex items-center gap-2">
                  <span>✅</span>
                  <span>Rapport d'impact législatif exporté avec succès !</span>
                </div>
              `;
