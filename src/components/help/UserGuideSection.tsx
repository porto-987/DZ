...
export function UserGuideSection() {
  ...
  const handleSearchUserGuide = (query: string) => {
    ...
    logger.info('UI', 'Recherche guide utilisateur', { query });
            ...
            <CardContent>
              {(() => {
                const {
                  ...
                  setCurrentPage,
                  setItemsPerPage
                } = getPaginatedArticles(category.articles, 3);
