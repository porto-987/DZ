...
export function LegalTextHistoryTab() {
  ...
  const handleCompareVersions = () => {
    ...
    // Ouvrir une modale de comparaison détaillée
      ...
      <div class="bg-white rounded-lg p-6 w-full max-w-6xl max-h-[80vh] overflow-y-auto">
        ...
        <div class="space-y-4">
          <div class="bg-blue-50 p-4 rounded border border-blue-200">
            <h4 class="font-medium text-blue-800 mb-2">Versions sélectionnées</h4>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div class="bg-green-50 p-4 rounded border border-green-200">
              ...
              <div class="space-y-2 text-sm">
                <div class="bg-white p-2 rounded">
                  <span class="text-green-600">+</span> Nouvelle section sur la protection des données
                </div>
                <div class="bg-white p-2 rounded">
                  <span class="text-green-600">+</span> Dispositions transitoires étendues
                </div>
                <div class="bg-white p-2 rounded">
                  <span class="text-green-600">+</span> Références aux normes internationales
                </div>
              </div>
            </div>
            ...
            <div class="bg-red-50 p-4 rounded border border-red-200">
              ...
              <div class="space-y-2 text-sm">
                <div class="bg-white p-2 rounded">
                  <span class="text-red-600">-</span> Anciennes dispositions obsolètes
                </div>
                <div class="bg-white p-2 rounded">
                  <span class="text-red-600">-</span> Références aux textes abrogés
                </div>
              </div>
            </div>
            ...
            <div class="bg-yellow-50 p-4 rounded border border-yellow-200">
              ...
              <div class="space-y-2 text-sm">
                <div class="bg-white p-2 rounded">
                  <span class="text-yellow-600">~</span> Seuils de sanctions mis à jour
                </div>
                <div class="bg-white p-2 rounded">
                  <span class="text-yellow-600">~</span> Procédures simplifiées
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-4 rounded">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p class="text-sm text-gray-600">Nouvelles obligations de conformité, délais d'adaptation de 6 mois</p>
              </div>
              <div>
                <h5 class="font-medium text-sm mb-1">Impact sur les citoyens</h5>
                <p class="text-sm text-gray-600">Amélioration de la protection des droits, procédures simplifiées</p>
              </div>
            </div>
          </div>
          
          <div class="bg-purple-50 p-4 rounded border border-purple-200">
            <h4 class="font-medium text-purple-800 mb-2">Conformité et recommandations</h4>
            <div class="space-y-2 text-sm">
              <div class="bg-white p-2 rounded">
                <span class="text-purple-600">✓</span> Conforme aux directives européennes
              </div>
              <div class="bg-white p-2 rounded">
                <span class="text-purple-600">✓</span> Aligné avec les standards internationaux
              </div>
              <div class="bg-white p-2 rounded">
                <span class="text-purple-600">⚠</span> Recommandation: Formation des agents publics
              </div>
            </div>
          </div>
