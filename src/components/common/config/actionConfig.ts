...
import { 
  ...
  Upload, FileDown, MapPin, Trash2, Edit,
...
export const actionConfig: Record<ActionType, ActionConfig> = {
  ...
  'recherche-ia': { icon: Search, label: 'Recherche Intelligente', variant: 'default' as const },
  ...
  'générer-ia': { icon: Zap, label: 'Générer avec l\'IA', variant: 'default' as const },
  ...
  'générer-formulaire': { icon: FileText, label: 'Générer le Formulaire de Base', variant: 'default' as const },
  'générer-rapport': { icon: FileText, label: 'Générer rapport', variant: 'default' as const },
