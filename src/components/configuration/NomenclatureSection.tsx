...
import { LegalTypeModal, ProcedureCategoryModal, LegalDomainModal, OrganizationModal, SignatoryManagementModal } from "@/components/modals/GenericModals";
import { LegalDatabaseWorkflowComponent } from "@/components/ocr/LegalDatabaseWorkflowComponent";
import { DocumentStatusTab } from './DocumentStatusTab';
    ...
    <div className="space-y-6">
      <Tabs defaultValue="legal-types" className="w-full">
        <TabsList className="grid w-full grid-cols-7">
          ...
          <TabsTrigger value="document-status">
